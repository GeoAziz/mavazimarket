...
| `NEXT_PUBLIC_FIREBASE_PROJECT_ID` | **CRITICAL:** Ensure this is exactly your ID (e.g., `mavazi-market`). Do NOT include duplicates or spaces. |
| `FIREBASE_ADMIN_SDK_CONFIG_JSON` | The entire service account JSON (as a single line). |
