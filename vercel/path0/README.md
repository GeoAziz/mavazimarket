...
| `NEXT_PUBLIC_FIREBASE_PROJECT_ID`       | Your Firebase project's ID. **(e.g., `mavazi-market`)** <br/> **CRITICAL:** Be careful not to paste the value twice (e.g., `mavazi-marketmavazi-market`). This will cause Firestore connection errors. | Client-side key                           |
